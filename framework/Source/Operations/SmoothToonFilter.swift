public class SmoothToonFilter: OperationGroup {
    ...
    public var threshold: Float = 0.2 { didSet { toonFilter.uniform.threshold = threshold } }
    public var quantizationLevels: Float = 10.0 { didSet { toonFilter.uniform.quantizationLevels = quantizationLevels } }
